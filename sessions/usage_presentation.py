...
from presentation.language import USER_WELLNESS_DISCLAIMER
from sessions.presentation_metrics import overview_metrics
...
def _vital_signals(detail: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "summary": (
            ...
            if available
            else ("ครั้งนี้ช่วงที่วัดชีพจรและการหายใจพร้อมกันยังไม่ต่อเนื่องพอ จึงยังสรุปแนวโน้มไม่ได้")
        ),
        "wellness_only": True,
    }
