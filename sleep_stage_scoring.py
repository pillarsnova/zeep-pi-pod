...
def candidate_from_stage_evidence(
    ...
    *,
    ...
    the configured consecutive evidence epochs (N2: four epochs/120 seconds;
    N3: two epochs/60 seconds), so neither override can create a stage from one
    noisy 30-second window.
    """
