# ZEEP Pilot · Two-Mode Test Protocol v1.2
...
| ถ้าไม่หลับ | Recovery Score จากการพัก/HR-RR/ความนิ่ง/สิ่งแวดล้อม เมื่อ release gates ผ่าน | แสดงว่าไม่พบการหลับ ไม่เปลี่ยนเป็น Nap อัตโนมัติ |
...
สูตรรุ่น v3.0 ใช้เส้นโค้งรากที่สองกับเวลาพัก, ให้ HR/RR ที่ผ่านหลักฐานขั้นต่ำ
...
คะแนน ไม่ได้รับแต้มและไม่หักซ้ำ Session ต้องมีเวลาอย่างน้อย 10 นาที มี HR/RR
ที่จับคู่กันอย่างน้อย 6 ตัวอย่าง และต้องบันทึกเป้าหมาย 30/90 นาทีจึงเผยแพร่
Recovery Score รุ่นปัจจุบันได้
