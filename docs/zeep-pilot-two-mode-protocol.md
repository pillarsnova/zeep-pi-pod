...
| จำเป็นต้องหลับ | ไม่จำเป็น | ใช่; หากไม่พบ Sleep State คะแนน Sleep Quality เป็น 0 |
| N3 / REM | ไม่บังคับและไม่หักเพราะไม่มี | ใช้ใน architecture score ตาม policy |
| ถ้าไม่หลับ | Rest Goal Score | แสดงว่าไม่พบการหลับ ไม่เปลี่ยนเป็น Nap อัตโนมัติ |
...
ระบบใช้ Sleep Score แบบช่วงพักสั้น แต่แสดงองค์ประกอบเป็นภาษาที่ไม่บังคับ
โครงสร้างการนอนค้างคืน:

- เวลาและการเข้าสู่การพัก 20
- ความต่อเนื่องของการพัก 30
- รูปแบบการพักที่ตรวจพบ 30
- การตอบสนองระหว่างพัก 15
- ความครบของข้อมูล 5

N3 และ REM เป็นข้อมูลที่อาจพบ ไม่ใช่เงื่อนไขรับคะแนน การงีบสั้นอาจมีประโยชน์
