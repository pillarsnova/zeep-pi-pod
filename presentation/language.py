...
RESPIRATORY_RECOMMENDATIONS = {
    ...
    "insufficient": ("ครั้งถัดไปลองพักให้นิ่งและจัดท่านอนให้สบาย เพื่อให้เซนเซอร์เก็บข้อมูลได้ต่อเนื่องขึ้น"),
}
...
def user_respiratory_baseline_copy(
    ...
    *,
    ...
    if reference_ready:
        return None, ("ข้อมูลอ้างอิงส่วนบุคคลพร้อมแล้ว แต่ข้อมูลครั้งนี้ยังไม่เพียงพอสำหรับเปรียบเทียบ")
    return None, (
...
def user_respiratory_interpretation(
    ...
    if key == "insufficient" or not paired_values_available:
        return "ครั้งนี้ช่วงที่วัดชีพจรและการหายใจพร้อมกันยังไม่ต่อเนื่องพอ จึงยังสรุปแนวโน้มไม่ได้"
    if key == "needs_recheck":
        return "บันทึกชีพจรและการหายใจได้ แต่รูปแบบการหายใจต่างจากช่วงอ้างอิง แนะนำให้ติดตามอีกครั้ง"
    if key == "supportive":
        return "บันทึกชีพจรและการหายใจได้ต่อเนื่อง โดยจังหวะหายใจค่อนข้างสม่ำเสมอระหว่างพัก"
    return "บันทึกชีพจรและการหายใจได้ต่อเนื่อง โดยจังหวะหายใจเปลี่ยนแปลงบางช่วง"
