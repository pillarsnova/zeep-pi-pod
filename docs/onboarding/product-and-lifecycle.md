...
| Session gate/restart/finalize | Handover §2 | [`sessions/live_sampler.py`](../../sessions/live_sampler.py), [`sessions/recording_start.py`](../../sessions/recording_start.py), [`sessions/finalization_summary.py`](../../sessions/finalization_summary.py), [`sessions/lifecycle.py`](../../sessions/lifecycle.py); resume/finalize I/O ประกอบใน `app.py` | `test_session_lifecycle.py`, `test_sleep_restart_context.py`, `test_recording_start.py`, `test_finalization_summary.py` |
