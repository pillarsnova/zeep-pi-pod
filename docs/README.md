...
**อัปเดต 23 ก.ย. 2026:** Knowledge Hub และเอกสารอยู่ใน commit `7cdb173`
รอบแรก `00047ad` ล้างโค้ดที่ไม่มีผู้เรียกและเครื่องมือปรับเสียงย้อนหลังที่เลิกใช้
รอบต่อเนื่องลบ CSS หน้าจอเก่าและ wrapper Admin โดยคงหน้าตาปัจจุบัน
อ่าน [ผลตรวจและรายการที่ลบ](reviews/2026-09-23-unused-code-cleanup.md)
ไม่เปลี่ยนสูตรคะแนน ไม่แก้ Raw และยังไม่ Deploy/Restart
หลักฐานตรวจ Pod ล่าสุดยังเป็นรอบ 22 ก.ย. 20:57 +07 (`78e90fc`)
