...
สถานะจัดชุด 23 ก.ย. 2026: คู่มือปัจจุบัน 60 บท; Knowledge Hub อยู่ใน
source commit `7cdb173` และเพิ่ม [ผลล้างโค้ด](../docs/reviews/2026-09-23-unused-code-cleanup.md)
Pod ที่ตรวจ 22 ก.ย. 20:57 +07 ยังเป็น `78e90fc`; ไม่ใช่หลักฐานว่า `/handbook`
