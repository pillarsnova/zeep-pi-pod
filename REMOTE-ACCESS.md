...
1. **ห้ามส่ง credential ผ่าน URL/query string** — หน้า Browser ให้ Login ตามปกติและใช้ Secure/HttpOnly Cookie; credential สำหรับ Backend หรือคำสั่งควบคุมต้องแยกสิทธิ์ เก็บฝั่ง Server และส่งผ่าน Header เท่านั้น
...
5. ฐานข้อมูล Profile/Session หลักยังจัดเก็บบน Pi ตามสถาปัตยกรรมปัจจุบัน แต่ traffic และ metadata ของ tunnel ผ่านผู้ให้บริการภายนอก จึงห้ามอ้างว่า “ไม่มีข้อมูลผ่าน Cloud” และต้องทบทวนการเข้ารหัส access log, retention, DPA/PDPA และสิทธิ์ผู้ดูแลของผู้ให้บริการก่อน Production
